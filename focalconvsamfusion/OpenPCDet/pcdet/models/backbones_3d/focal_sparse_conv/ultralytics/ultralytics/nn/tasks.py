...
class BaseModelFastSam(nn.Module):
    """
    The BaseModel class serves as a base class for all the models in the Ultralytics YOLO family.
    """
...
class DetectionModelFastSam(BaseModelFastSam):
...
class SegmentationModel(DetectionModelFastSam):
