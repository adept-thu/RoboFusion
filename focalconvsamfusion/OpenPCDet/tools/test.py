...
def parse_config():
    ...
    parser.add_argument('--tcp_port', type=int, default=25908, help='tcp port for distrbuted training')
    ...
    parser.add_argument('--save_cor_flag', action='store_true',default=False, help='generate offline corruptions pkl')
...
def main():
    ...
    log_file = eval_output_dir / f"log_eval_{args.corruptions}_{args.severity}_{timestr}.txt"  # dxg print log
    ...
    test_set, test_loader, sampler = build_dataloader(
        ...
        corruptions=args.corruptions, severity=args.severity, save_cor_flag=args.save_cor_flag # dxg add corruptions, severity
    )
