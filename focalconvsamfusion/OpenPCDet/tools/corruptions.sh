...
cfg_file=../checkpoints/sam_onlinev3/v3_avg_fpn/sam_onlinev3.yaml
batch_size=16 # total batch size
ckpt=../checkpoints/sam_onlinev3/v3_avg_fpn/ckpt/checkpoint_epoch_73.pth
...
# setting
demo1=(density cutout crosstalk gaussian_l uniform_l impulse_l gaussian_c uniform_c impulse_c moving_bbox motion_blur density_bbox cutout_bbox gaussian_bbox_l uniform_bbox_l impulse_bbox_l)
