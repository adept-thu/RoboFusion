...
model = dict(
    ...
    network2d=dict(
        type='SamImageEncoderWithFPN',
        optimize=True,
        model_cfg=dict(
            args={"feat_extract_layer": ["layer1"]},
            pretrained_path="../checkpoints/sam_image_encoder_b.pth",
            is_optim_sam=False,
            model_type="vit_b",
            channel_reduce={
                "in_channels": [256],
...
train_anno = "data/nuScenes/infos_train_mini_1_4_10sweeps_withvelo_filter_True.pkl"
