...
from .basic_utils import Conv2d, get_norm
...
class SimpleFeaturePyramid(nn.Module):
    ...
    def __init__(
        ...
        self.layer_list = ["layer{}".format(int(i+1))  for i in range(len(scale_factors))]
    ...
    def forward(self, bottom_up_features):
        ...
        result_dict = {f: res for f, res in zip(self.layer_list, results)}
        return_dict = {}
        for ret_layer in self.return_layer:
            return_dict[ret_layer] = result_dict[ret_layer]
        return return_dict
